...
# bullet_fire_sound = pygame.mixer.Sound("SFX/Bullet_fire_sound.mp3")
# bullet_hit_sound = pygame.mixer.Sound("SFX/bullet_hit_sound.mp3")


jet_left_img = pygame.image.load("Textures/jet_left.png")
jet_right_img = pygame.image.load("Textures/jet_right.png")
...
class Agent:
    def __init__(self):
        ...
        self.state_time_counters = np.zeros((NUM_STATES, NUM_STATES, NUM_STATES, NUM_STATES))
